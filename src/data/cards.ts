...
export const missionCards: MissionCard[] = [
  {
    ...
    question:
      '你刚来一所学校时，最希望有人帮你解释哪件事？选课、请假、校历、社团，还是老师邮件？',
    insight:
      '先别做“全校万能助手”。从一个真实场景开始：帮一位新生家庭看懂一封学校邮件，并给出下一步行动。',
    difficulty: '中',
    impactScore: 92,
    techScore: 58,
    mapX: 46,
  ...
  },
  {
    ...
    question:
      '你家、家乡或社区里，有没有一种文字、方言、节日、手艺或故事，外人很难一下子看懂？',
    insight:
      '把文化项目做成“能玩、能问、能练”的工具：先选20个条目，再让AI帮用户理解、记住、用起来。',
    difficulty: '中高',
    impactScore: 76,
    techScore: 64,
    mapX: 54,
  ...
  },
  {
    ...
    question:
      '在学校里，谁可能因为听不见、看不清、语言不同或表达方式不同，而错过重要信息？',
    insight:
      '先选一个很小的沟通场景，比如食堂点餐、课堂求助或社团报名。让AI准确识别几个高频需求，比做一个大而空的翻译器更有用。',
    difficulty: '高',
    impactScore: 90,
    techScore: 86,
    mapX: 82,
  ...
  },
  {
    ...
    question:
      '你每天有哪些状态其实会影响学习和生活，比如睡眠、精力、情绪、运动或饮水？你想让AI帮你看懂哪一个？',
    insight:
      '健康类项目要温和、谨慎。让AI做记录、提醒和反思，不做诊断；同时写清楚隐私、边界和求助建议。',
    difficulty: '高',
    impactScore: 86,
    techScore: 72,
    mapX: 68,
  ...
  },
  {
    ...
    question:
      '你身边有没有一种“小变化”，平时很容易被忽略，但如果早点发现会很有帮助？比如睡眠、情绪、运动、饮食、姿势，AI可以提醒谁、提醒什么？',
    insight:
      '别一开始就做一个很大的健康系统。先选一个你能观察、能记录、能验证的小信号，让AI帮一个真实的人更早发现变化。',
    difficulty: '高',
    impactScore: 80,
    techScore: 92,
    mapX: 90,
